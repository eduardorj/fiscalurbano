...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'fiscalizacao_userprofile', 'phone')

        # Adding field 'UserProfile.mobile'
        db.add_column(u'fiscalizacao_userprofile', 'mobile',
                      self.gf('django.db.models.fields.IntegerField')(default=0, unique=True, max_length=13),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'UserProfile.phone'
        db.add_column(u'fiscalizacao_userprofile', 'phone',
                      self.gf('django.db.models.fields.IntegerField')(max_length=13, unique=True),
                      keep_default=False)

        # Deleting field 'UserProfile.mobile'
        db.delete_column(u'fiscalizacao_userprofile', 'mobile')
    ...
    models = {
        ...
        u'fiscalizacao.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mobile': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'max_length': '13'}),
